...
public class TotalCrewAdapter extends RecyclerView.Adapter<TotalCrewAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public TotalCrewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        TotalCrewAdapter.ViewHolder hvh = new TotalCrewAdapter.ViewHolder(view);
        // 뷰홀더 생성 , 리턴값이 뷰홀더이다.
        return hvh;
    }

    @Override
    public void onBindViewHolder(@NonNull TotalCrewAdapter.ViewHolder holder, int position) {
